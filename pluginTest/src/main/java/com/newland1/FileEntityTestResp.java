 ...
 */
@FileEntity(delimiter = "|",rowSize=530,isFix=true,fields = {"tradeTimeString", "branchNo", "jzjydm"})
public class FileEntityTestResp {
	...
	@DataColumn(name = "交易日期",  pattern = "yyyyMMdd")
